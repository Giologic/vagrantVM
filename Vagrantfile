...
Vagrant::Config.run do |config|
	...
	#config.vm.box_url = "http://vmimages.torchbox.com/djang	o-base-v2.2.box"  # Torchbox-internal URL to django-base.box
	...
	config.vm.share_folder "project", "/home/vagrant/gridlock", "."

	# Enable provisioning with a shell script.
	config.vm.provision :shell, :path => "etc/install/install.sh", :args => "gridlock"
end
